    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="riwayat_pendidikan.php?id=<?= htmlspecialchars($user['id']) ?>" class="btn btn-success btn-sm">Tambah Riwayat Pendidikan</a>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="edit_riwayat_pendidikan.php?id=<?= $riwayat['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="delete_riwayat_pendidikan.php?id=<?= $riwayat['id'] ?>&user_id=<?= htmlspecialchars($user['id']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span>Project</span>
                <a href="project.php?user_id=<?= htmlspecialchars($user['id']) ?>" class="btn btn-success btn-sm">Tambah Project</a>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="assets/images/<?= htmlspecialchars($project['images']) ?>" alt="Gambar Proyek" width="100">
                            </td>
                            <td>
