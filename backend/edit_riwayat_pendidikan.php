...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql_update = "UPDATE riwayat_pendidikan 
                   SET pendidikan = '$pendidikan', tahun = '$tahun', nama_sekolah_kampus = '$nama_sekolah_kampus' 
                   WHERE id = '$id'";
    ...
    <div class="container mt-5">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_sekolah_kampus" name="nama_sekolah_kampus" value="<?= $riwayat['nama_sekolah_kampus'] ?>" required>
            </div>
