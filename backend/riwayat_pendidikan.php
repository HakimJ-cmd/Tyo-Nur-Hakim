...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tahun = $_POST['tahun'];
    $nama_sekolah_kampus = $_POST['nama_sekolah_kampus'];

    // query buat create data riwayat_pendidikan
    $sql = "INSERT INTO riwayat_pendidikan (user_id, pendidikan, tahun, nama_sekolah_kampus) 
            VALUES ('$user_id', '$pendidikan', '$tahun', '$nama_sekolah_kampus')";
...
<body>
    <div class="container mt-5">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                <label for="nama_sekolah_kampus" class="form-label">Nama Sekolah/Kampus</label>
                <input type="text" class="form-control" id="nama_sekolah_kampus" name="nama_sekolah_kampus" required>
            </div>
